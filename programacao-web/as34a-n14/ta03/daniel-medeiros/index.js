...
function setConfigs(data){
    var ConfigsContainer = document.getElementById('configs-container');
    var StringConfigs = '';

    StringConfigs += "<h1>" + data.configs.title + "</h1>";
    StringConfigs += "<h2>" + data.configs.subTitle + "</h2>";
    StringConfigs += "<p>" + data.configs.email + "</p>";
    StringConfigs += "<p>" + data.configs.phone + "</p>";
    StringConfigs += "<p>" + data.configs.description[0].p + "</p>";
    StringConfigs += "<p>" + data.configs.description[1].p + "</p>";
    StringConfigs += "<h2>" + data.configs.description[2].h2 + "</h2>";
    StringConfigs += "<p>" + data.configs.description[3].p + "</p>";

    ConfigsContainer.innerHTML = StringConfigs;
}
...
function setProducts(data){
    ...
    for(let x = 0; x < data.products.length; x++){
        stringProducts += "<div class=\"product\">";
