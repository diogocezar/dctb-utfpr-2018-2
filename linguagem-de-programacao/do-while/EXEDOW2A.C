/* Exemplo 2 de uso da estrutura de repetição do..while

   Neste exemplo, caso o usuário digita uma letra, salário continuará
   valendo o seu valor de declaração, ou seja, um valor desconhecido
   (lixo de memória).

   E caso o lixo seja maior ou igual a zero, não é feita a leitura novamente.

   A mesma coisa para a leitura do aumento.

   Então não adianta apenas por fflush em alguns casos.
